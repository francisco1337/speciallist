    ...
    $('.flexslider').flexslider({
      ...
      start: function(slider) {
        var sliderMain = $('.slider-1 .flex-active-slide');
         ...
         sliderMain.find('.item').animate({ left: '0', opacity: '1'}, 1000);
         sliderMain.find('.fade-flex').css({ top: topfade});
         sliderMain.find('.fade-flex').animate({ opacity: '1'}, 1000);
         sliderMain.find('.flex-top-bot').animate({ right:'0', top: toptitle, opacity: '1'}, 1500);
         sliderMain.find('.flex-bot-top').animate({ right:'0', bottom: bottomtext, opacity: '1'}, 1500);
         sliderMain.find('.links').css({ bottom: bottomlinks});
         sliderMain.find('.links').animate({ right:'0', opacity: '1'}, 1800);
      ...
      before: function(slider) {
        var sliderMain = $('.slider-1 .flex-active-slide');
         ...
         sliderMain.find('.item').animate({ left: '-100%', opacity: '0'}, 1000);
         sliderMain.find('.fade-flex').animate({ opacity: '0'}, 1000);
         sliderMain.find('.flex-top-bot').animate({ right:'0', opacity: '0'}, 1500);
         sliderMain.find('.flex-bot-top').animate({ right:'0', bottom: '-50%', opacity: '0'}, 1500);
         sliderMain.find('.links').animate({ right:'-100%', opacity: '0'}, 1800);
          },
